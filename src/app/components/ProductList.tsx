      ...
      {res.items.map((product: products.Product) => (
        ...
        >
          ...
          <div className="flex justify-between">
            ...
            <span className="semibold">€{product.price?.price}</span>
          </div>
          ...
          <button className="rounded-2xl ring-1 ring-mustoo text-mustoo w-max py-2 px-2 text-xs hover:bg-mustoo hover:text-white">
            Add to cart
          </button>
        </Link>
      ))}
